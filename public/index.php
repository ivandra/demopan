...
$router->get('/ai/generate-meta', action($ai, 'generateMeta'));
$router->post('/ai/generate-meta', action($ai, 'generateMeta'));
$router->get('/ai/generate-subdomains', action($ai, 'generateSubdomains'));
...
$router->post('/ai/entity-settings/save', action($ai, 'saveEntitySettings'));
// Debug
